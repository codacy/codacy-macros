...
pomExtra :=
  <scm>
    <url>https://github.com/codacy/codacy-macros</url>
    <connection>scm:git:git@github.com:codacy/codacy-macros.git</connection>
    <developerConnection>scm:git:https://github.com/codacy/codacy-macros.git</developerConnection>
  </scm>
    <developers>
      <developer>
        <id>johannegger</id>
